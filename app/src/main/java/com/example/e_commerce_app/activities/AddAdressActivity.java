        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!userName.isEmpty() && !userCity.isEmpty() && !userAdress.isEmpty() && !userCode.isEmpty() && !userNumber.isEmpty()){
                    ...
                    firestore.collection("CurrentUser").document(auth.getCurrentUser().getUid())
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(AddAdressActivity.this,"Adress added",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddAdressActivity.this,"Kindly Fill All Field",Toast.LENGTH_SHORT);
                }
