...
import com.example.e_commerce_app.adaptres.CategoryAdapter;
import com.example.e_commerce_app.adaptres.NewProductAdapter;
import com.example.e_commerce_app.adaptres.PopularProductAdapter;
...
/*
        ...
        slideModels.add(new SlideModel(R.drawable.banner3,"70% OFF, ScaleTypes.CENTER_CROP", ScaleTypes.CENTER_CROP));


        imageSlider.setImagesList(slideModels);
